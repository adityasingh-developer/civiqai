...
const SYSTEM_PROMPT =
  ...
  "If unsure or not real, reply exactly: Not found. Respond in simple(use simple language not legal language(like legal hindi is hard), use simple language), short, factual points (700-1500 chars max). " +
