                ...
                {session?.user ? (
                  <div className="relative">
                    ...
                    <label
                      ...
                      className="inline-flex h-10 w-10 items-center justify-center overflow-hidden rounded-full bg-white/20 text-white font-semibold cursor-pointer"
                    ...
                    <div className="absolute right-0 top-full mt-2 min-w-[18rem] rounded-2xl bg-stone-100 p-4 text-stone-800 shadow-2xl opacity-0 -translate-y-1.5 pointer-events-none transition-[opacity,transform] duration-300 ease-out peer-checked:opacity-100 peer-checked:translate-y-0 peer-checked:pointer-events-auto dark:bg-stone-800 dark:text-stone-100">
                      <div className="flex items-center justify-between gap-3">
                        ...
                        <label
                          htmlFor="profile-menu-toggle"
                          className="inline-flex h-6 w-6 items-center justify-center rounded-full bg-stone-200/80 text-md font-semibold text-stone-700 hover:bg-stone-200 dark:bg-stone-700 dark:text-stone-100 dark:hover:bg-stone-600 cursor-pointer"
                          aria-label="Close profile menu"
                        >
                          ×
                        </label>
                      </div>
                      <ul className="mt-3 flex flex-col gap-2 text-lg text-stone-800 dark:text-stone-100">
                        <li>
                          <Link
                            href="/chat"
                  ...
                  <button
                    type="button"
                    onClick={() => signIn()}
                    className={`inline-flex items-center gap-2 rounded-full bg-white/20 px-4 text-md font-medium text-white shadow-sm duration-200 cursor-pointer hover:bg-stone-700 dark:bg-stone-950/30 dark:text-stone-100 ${isLoading ? "pb-5 pt-2" : "py-1"}`}
                  >
                    {isLoading ? (
                      <LoadingDots />
                    ) : (
