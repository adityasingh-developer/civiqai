      ...
      <ReactMarkdown
        components={{
          h1: (props) => (
            <h1
              {...props}
              className="mb-2 border-b border-stone-300 pb-2 text-2xl font-semibold tracking-tight text-stone-900 dark:border-stone-600 dark:text-stone-50"
            />
          ),
          h2: (props) => (
            <h2
              {...props}
              className="mb-2 border-b border-stone-300 pb-2 text-xl font-semibold tracking-tight text-stone-900 dark:border-stone-600 dark:text-stone-50"
            />
          ),
          h3: (props) => (
            <h3
          ...
          em: (props) => (
            <em
              {...props}
              className="italic text-stone-700 dark:text-stone-200"
            />
          ),
          code: (props) => (
            <code
              {...props}
              className="rounded bg-stone-200/70 px-1 py-0.5 font-mono text-[13px] text-stone-900 dark:bg-stone-700/60 dark:text-stone-100"
            />
          ),
          blockquote: (props) => (
            <blockquote
              {...props}
              className="my-2 border-l-2 border-stone-300 pl-3 text-md text-stone-700 dark:border-stone-600 dark:text-stone-200"
            />
          ),
        }}
      >
